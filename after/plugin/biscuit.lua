...
--         { bold = true, cterm = { bold = true, italic = true }, fg = "#3DDBD9", italic = true })
...
--         { cterm = { undercurl = true }, fg = "#EE5396", sp = "#F07342", undercurl = true })
--     HI(0, "DiagnosticUnderlineWarn",
--         { cterm = { undercurl = true }, fg = "#BE95FF", sp = "#CF223E", undercurl = true })
