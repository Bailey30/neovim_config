...
" call <sid>hi("Visual",        s:gui01, s:guiYellow, "", s:cterm02, "")
highlight Visual guifg=NONE guibg=NONE gui=reverse ctermfg=178 ctermbg=NONE cterm=reverse
...
call <sid>hi("VertSplit",     s:gui00, "none", "none", "none", "none")
	highlight WinBar guifg=#000000 guibg=#1c1c1c gui=NONE ctermfg=4 ctermbg=1 cterm=NONE
    " call <sid>hi("VertSplit",        s:gui05, s:gui00, s:cterm05, s:cterm00, "")
	" highlight VertSplit guifg=#000000 guibg=#1c1c1c gui=NONE ctermfg=4 ctermbg=1 cterm=NONE
...
" call <sid>hi("LineNr",    s:gui03, s:gui00, s:cterm0B, s:cterm01, "none")
" call <sid>hi("LineNrAbove",    s:gui0B, s:gui00, s:cterm0B, s:cterm01, "none")
" call <sid>hi("LineNrBelow",    s:gui0B, s:gui00, s:cterm0B, s:cterm01, "none")
...
call <sid>hi("Keyword",      s:gui0C, "", s:cterm0E, "", "")
...
" call <sid>hi("NeotreeDirectoryName",   s:guiYellow, "", s:cterm08, "", "none")
call <sid>hi("NeotreeGitUnstaged",   s:gui0B, "", s:cterm08, "", "none")
